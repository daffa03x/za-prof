                    ...
                    @method('PUT')
                        <div class="form-row">
                            <div class="form-group col-md-10">
                                ...
                                <input type="text" class="form-control @error('id_event') is-invalid @enderror" name="id_event" value="{{ old('id_event', $data->id_event) }}" autofocus>
                                    @error('id_event')
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="number" class="form-control @error('jumlah_tiket') is-invalid @enderror" value="{{ old('jumlah_tiket', $data->jumlah_tiket) }}" name="jumlah_tiket">
                                    @error('jumlah_tiket')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $data->email) }}" name="email">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('telepon') is-invalid @enderror" value="{{ old('telepon', $data->telepon) }}" name="telepon">
                                    @error('telepon')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="jenis_kelamin" name="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror">
                                    <option value="" {{ old('jenis_kelamin', $data->jenis_kelamin) == '' ? 'selected' : '' }}>Choose...</option>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ old('tanggal_lahir', $data->tanggal_lahir) }}" name="tanggal_lahir">
                                    @error('tanggal_lahir')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
