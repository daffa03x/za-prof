            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('payment.edit', $item->id) }}" class="btn btn-sm btn-warning m-1">Edit</a>
                            <form action="{{ route('payment.destroy', $item->id) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete();">
                                @csrf
                                @method('DELETE')
