                    ...
                    <form action="{{ route('event.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="url" class="form-control @error('website') is-invalid @enderror" id="website" name="website" value="{{ old('website', $data->website) }}">
                                @error('website')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('mitra') is-invalid @enderror" id="mitra" name="mitra" value="{{ old('mitra', $data->mitra) }}">
                                @error('mitra')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="datetime-local" class="form-control @error('waktu_mulai') is-invalid @enderror" name="waktu_mulai" value="{{ old('waktu_mulai', $data->waktu_mulai )}}">
                                    @error('waktu_mulai')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="datetime-local" class="form-control @error('waktu_berakhir') is-invalid @enderror" name="waktu_berakhir" value="{{ old('waktu_berakhir', $data->waktu_berakhir )}}">
                        ...
                        <div class="form-row">
                            <div class="form-group flex-nowrap col-md-8">
                                ...
                                <input type="text" class="form-control @error('harga') is-invalid @enderror" name="harga" id="harga" oninput="formatNumber(this)" value="{{ old('harga', $data->harga )}}">
                                @error('harga')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control @error('jumlah_tiket') is-invalid @enderror" name="jumlah_tiket" value="{{ old('jumlah_tiket', $data->jumlah_tiket )}}">
                                    @error('jumlah_tiket')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
