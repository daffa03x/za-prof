                    ...
                    @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="datetime-local" class="form-control @error('waktu_mulai') is-invalid @enderror" name="waktu_mulai">
                                    @error('waktu_mulai')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="datetime-local" class="form-control @error('waktu_berakhir') is-invalid @enderror" name="waktu_berakhir">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control @error('nama_tempat') is-invalid @enderror" name="nama_tempat">
                                    @error('nama_tempat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-row">
                            <div class="form-group flex-nowrap col-md-8">
                                ...
                                <input type="text" class="form-control @error('harga') is-invalid @enderror" name="harga" id="harga" oninput="formatNumber(this)">
                                @error('harga')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
