    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="py-4 d-flex justify-content-between align-items-center">
                <div>
                    <a href="{{ route('pixel.create') }}" class="btn btn-success">Add</a>
                </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('pixel.edit', $item->id) }}" class="btn btn-sm btn-warning m-1">Edit</a>
                            <form action="{{ route('pixel.destroy', $item->id) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete();">
                                @csrf
                                @method('DELETE')
